  ...
  return (
    <>
      <footer className=" bg-black  relative">
        <Fade>
        <section className="max-w-[1300px] mx-auto bg-black w-[80%] sm:w-[90%] mx-auto text-white pt-[180px] sm:pt-[90px] relative z-0">
          <div className="relative z-2">
            <h1 className="text-center text-gold-500 text-ReadexPro font-bold text-[36px] sm:text-[26px] mb-[30px]">CYBER OUTLAWS NFT</h1>
            <div className="sm:text-[13px] text-Barlow font-medium flex flex-wrap justify-center gap-x-[66px] sm:gap-x-[33px] ">
              <div>
        ...
        {/* <div 
            className="z-1 absolute -top-0 right-0 w-[350px] h-full"
            style={{  
